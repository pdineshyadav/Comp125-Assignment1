...
/*
    ...
    functionOfFirstParagraph();
        ...
        //Project Page 
        // First Paragraph in Projects Page 
        var projectsParaOneTag = document.getElementById("projectsParagraphOne");
        
        var projectsParagraphOne = "Para 1";
        
        // declare named function
        function functionOfProjectParaOne() 
        {
            
            // create a reference to a p element with an id of "firstParagraph"
            
            projectsParaOneTag.textContent = projectsParagraphOne;
            
        }
        
        functionOfProjectParaOne();
        ...
        //Second Paragraph in Projects Page 
        var projectsParaTwoTag = document.getElementById("projectsParagraphTwo");
        
        var projectsParagraphTwo = "Para 2";
        
        // declare named function
        function functionOfProjectParaTwo() 
        {
            
            // create a reference to a p element with an id of "firstParagraph"
            
            projectsParaTwoTag.textContent = projectsParagraphTwo;
            
        }
        

        functionOfProjectParaTwo(); 
        ...
        // Third Paragraph in Projects Page
        
        var projectsParaThreeTag = document.getElementById("projectsParagraphThree");
        
        var projectsParagraphThree = "Para 3";
        
        // declare named function
        function functionOfProjectParaThree() 
        {
            
            // create a reference to a p element with an id of "firstParagraph"
            
            projectsParaThreeTag.textContent = projectsParagraphThree;
